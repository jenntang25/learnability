...
user1 = User.create!(email: "test@test.com", first_name: "Antoine", last_name: "Guilguet", password: "123456")
user2 = User.create!(email: "test1@test.com", first_name: "Alberto", last_name: "GUGU", password: "123456")
user3 = User.create!(email: "test2@test.com", first_name: "Jenny", last_name: "Tang",password: "123456")

est1 = Establishment.create!(name: "Cerveceria", country: "Spain", city: "Barcelona", user: user1)
